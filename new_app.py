...
app2.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://fwsbrmejpihtpr:63694976e4b5c59af5029d3802c625c2ab89828c15f55049f86fe58156f744e9@ec2-34-250-252-161.eu-west-1.compute.amazonaws.com:5432/d3m1dq8b7u0ors'
...
@app2.route('/save_game_data', methods=['POST'])
def save_game_data():
    data = request.json
...
@app2.route('/load_game_data', methods=['GET'])
def load_game_data():
